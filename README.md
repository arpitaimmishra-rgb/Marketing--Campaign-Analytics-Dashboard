...
2. Short Description
   ...
   records to measure and compare marketing campaign effectiveness across 
   4 channels — Email, SMS, Social, and Push. Designed to help marketing 
   teams identify top-performing channels, optimise budget allocation, 
   and improve customer engagement outcomes.
...
5. Features & Highlights
   ...
   Segment Analysis — Donut chart showing conversions by customer segment
...
6. Business Problem
   ...
   knowing which channel actually drives conversions. This dashboard 
   solves that by giving a single view of campaign performance — making 
   it easy to compare channels, identify weak campaigns, and reallocate 
   budget where it performs best.

7. Key Questions Answered
a. Which channel has the highest Click-Through Rate?
b. Which campaign drove the most conversions?
c. Which customer segment converts best?
d. Which channel gives the lowest Cost per Response?
e. How has CTR % trended month over month?
f. Where should budget be reallocated for maximum ROI?

8. Business Impact & Insights
   Email CTR (21.8%) is 2x higher than SMS (11.1%)
   Email Conversion Rate (1.1%) is 5x better than SMS (0.2%)
   Push channel gives lowest Cost per Response at ₹1.1 per click
